...
function commitUrlFromRemote(sha) {
...
function detectCiEnvironment() {
    ...
    let ciPlatform;
    let ciBuildUrl;
    let gitHashCommitUrl;
    const gitCommitSha = firstDefined(process.env.GITHUB_SHA, process.env.CI_COMMIT_SHA, process.env.BUILD_SOURCEVERSION, process.env.BITBUCKET_COMMIT, process.env.GIT_COMMIT, () => tryGit(['rev-parse', 'HEAD']));
    if (github) {
        ciPlatform = 'github';
