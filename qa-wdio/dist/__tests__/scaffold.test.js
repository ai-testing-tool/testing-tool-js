...
(0, node_test_1.describe)('@qanalyzer/forge-wdio scaffold', () => {
    (0, node_test_1.it)('loads reporter module and no-ops when mode=off', async () => {
        ...
        await (0, hooks_js_1.beforeRunHook)({ mode: forge_commons_1.ModeEnum.off, projectKey: 'AUTH' });
        ...
        const instance = forge_commons_1.QAnalyzerReporter.getInstance();
    ...
    (0, node_test_1.it)('assertHooksForMode throws in debug when hooks missing (NFR33)', () => {
        hooks_js_1.hooksLifecycle.reset();
        strict_1.default.throws(() => (0, hooks_js_1.assertHooksForMode)(forge_commons_1.ModeEnum.ingest, true), /beforeRunHook|afterRunHook|NFR33/);
    });
});
