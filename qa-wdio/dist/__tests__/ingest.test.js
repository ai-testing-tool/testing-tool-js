...
(0, node_test_1.describe)('QaWdioReporter modes', () => {
    (0, node_test_1.it)('mode=off completes without credentials', async () => {
        ...
        results_buffer_js_1.ResultsBuffer.reset({ mode: qa_javascript_commons_1.ModeEnum.off });
        await (0, hooks_js_1.beforeRunHook)({ mode: qa_javascript_commons_1.ModeEnum.off });
        const reporter = new reporter_js_1.QaWdioReporter({ mode: qa_javascript_commons_1.ModeEnum.off });
